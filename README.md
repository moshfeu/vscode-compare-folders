...
- `skipSymlinks` - boolean - ignore symbolic links during comparison. This can help avoid issues with symlinks (default: false). Note: circular symlinks that form infinite loops may still need to be fixed manually
